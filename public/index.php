...
<body class="<?= $version ? 'version-' . $version : '' ?> ">
    ...
    <div class="container">
        <div class="main__content">
            ...
            <h1 class="main__title">Демо-портал единоборств</h1>
            <p class="main__text">Демо-верстка: доступ к&nbsp;прямым эфирам турниров, архиву боев, турнирам по&nbsp;разным дисциплинам единоборств, новостям и&nbsp;образовательному контенту (без привязки к&nbsp;реальному сервису).</p>
            <a href="https://example.com/demo/register" class="main__button button">Регистрация бесплатно</a>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="form-reg__box">
            ...
            <a href="https://example.com/demo/register" class="form-reg__button button">Регистрация</a>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="price__box" id="price">
            ...
            <li>Уроки от&nbsp;лучших представителей российской школы единобрств</li>
                ...
                <a href="https://example.com/demo/register" class="price-card__button button">Регистрация</a>
            </div>
            ...
            <li>Доступ к&nbsp;первому в&nbsp;России онлайн &laquo;Факультету ММА&raquo;</li>
                ...
                <a href="https://example.com/demo/register" class="price-card__button button">Скоро</a>
            </div>
            ...
            <li>Полный архив соревнований и&nbsp;мастер-классов</li>
            <li>Доступ к&nbsp;первому в&nbsp;России онлайн &laquo;Факультету ММА&raquo;</li>
            <li>Возможность попасть в команду профессионалов (демо-текст)</li>
    ...
    <div class="container">
        <div class="footer__box">
            ...
            <div class="footer__developer">
                <div class="footer__developer-box footer__link"><a class="footer__link" target="_blank" rel="noopener noreferrer" href="https://example.com/demo/privacy">Политика конфиденциальности (демо)</a></div>
            </div>
        </div>
    </div>
</footer>
